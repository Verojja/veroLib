...
BEGIN TRANSACTION
/*Remeber to switch to explicit COMMIT TRANSACTION (line 201) for the production deploy.
...
/******************************************************Objects Required for indipendent testing**************************************************/
	/*
		No pre-existing objects required.
	*/
/************************************************************************************************************************************************/
/************************************************************************************************************************************************/
GO
...
(
	...
	CONSTRAINT PK_ProductGroup_productGroupId
...
(
	...
	productHierarchyLvl1 VARCHAR(75) NOT NULL,
	productHierarchyLvl2 VARCHAR(75) NOT NULL,
	productHierarchyLvl3 VARCHAR(75) NOT NULL,
	dateInserted DATE NOT NULL,
...
CREATE NONCLUSTERED INDEX FNIX_ProductHierarchy_productTransactionCodeRemap
	ON DecisionNet.ProductHierarchy (productTransactionCodeRemap)
		INCLUDE (productTransactionDescription, productHierarchyLvl1, productHierarchyLvl2, productHierarchyLvl3, dateInserted)
...
(
	...
	*/
	productHierarchyLvl1 VARCHAR(75) NULL,
	productHierarchyLvl2 VARCHAR(75) NULL,
	productHierarchyLvl3 VARCHAR(75) NULL,
	billableMatchCode CHAR(1) NULL, /*F_BILL_MTCH*/
	billableNonMatchCode CHAR(1) NULL, /*F_BILL_NO_MTCH*/
	...
	*/
	...
	recentlyObservedOldProductCode CHAR(9) NULL, /*C_PS_PRD_OLD*/
	...
	*/
	...
	CONSTRAINT CK_Product_billableNonMatchCode_ASSERT_KnownValueORNULL
		CHECK (billableNonMatchCode IS NULL OR billableNonMatchCode IN ('Y','N','I'))
);
GO
IF(@@TRANCOUNT <1 OR @@ERROR <> 0)
BEGIN
...
(
	...
	invoiceExecutionDate DATETIME2(5) NOT NULL, /*D_LN_ITM_EXRCT_RUN*/
...
CREATE NONCLUSTERED INDEX NIX_Expenditure_productTransactionCode
	ON DecisionNet.Expenditure (productTransactionCode)
		INCLUDE (invoiceExecutionDate, lineItemQuantity, lineItemUnitCost, lineItemTax, companySoldToCode, companyShippedToCode);
CREATE NONCLUSTERED INDEX NIX_Expenditure_invoiceExecutionDate
	ON DecisionNet.Expenditure (invoiceExecutionDate)
		INCLUDE (productCode, lineItemQuantity, lineItemUnitCost, lineItemTax);

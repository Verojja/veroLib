...
(
	...
	taxIdentificationNumberObfuscated VARCHAR(15) NULL, /*For aliens and corporations (called EIN)*/ -- DCR
	taxIdentificationNumberLastFour CHAR(4) NULL, /*For aliens and corporations (called EIN)*/ -- DCR
	socialSecurityNumberObfuscated VARCHAR(30) NULL,			-- DCR (N_SSN4 from clt7a
...
CREATE NONCLUSTERED INDEX NIX_InvolvedParty_isServiceProviderOfInvolvedPartyId
	ON dbo.InvolvedParty (involvedPartyId)

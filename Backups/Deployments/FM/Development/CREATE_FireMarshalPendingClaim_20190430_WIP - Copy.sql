...
(   
	...
	siuCompanyName BIT NULL,
	siuRepresentativeFullName BIT NULL,
	siuWorkPhoneNumber BIT NULL,
	siuCellPhoneNumber BIT NULL,
...
CREATE NONCLUSTERED INDEX NIX_FireMarshalPendingClaim_isCurrent_isActive
	...
	INCLUDE (claimId, isoFileNumber, reportingStatus, fMstatus, fireMarshallDate, claimIsOpen, dateSubmittedToIso, originalClaimNumber, originalPolicyNumber, insuranceProviderOfficeCode, insuranceProviderCompanyCode, companyName, affiliate1Code, affiliate1Name, affiliate2Code, affiliate2Name, groupCode, groupName, lossAddressLine1, lossAddressLine2, lossCityName, lossStateCode, lossStateName, lossZipCode, lossLatitude, lossLongitude, lossDescription, lossDescriptionExtended, dateOfLoss,
...
(
	SELECT
		...
		FireMarshalPendingClaim.fMstatus,
...
END
GO
CREATE UNIQUE CLUSTERED INDEX PK_ActiveCurrentPendingFMClaim_elementalClaimId
	ON dbo.V_ActiveCurrentPendingFMClaim (elementalClaimId)
	WITH (FILLFACTOR = 80);
GO
IF(@@TRANCOUNT <1 OR @@ERROR <> 0)
BEGIN

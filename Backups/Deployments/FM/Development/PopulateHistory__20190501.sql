...
SELECT
	...
	'Sent on __Date___' AS fmStatus, --<---- we can update this later, I just need the claims loaded.
	'20190404' AS fireMarshallDate, --<---- we can update this later, I just need the claims loaded.
	FireMarshalController.projectedGenerationDate,
	1 AS claimIsOpen, --<---- we can update this later if needed, I just need the claims loaded. feel free to change it now.
...
WHERE
	...
	--AND FireMarshalClaimSendHistory.elementalClaimId IS NULL <----- leave this commented out; 

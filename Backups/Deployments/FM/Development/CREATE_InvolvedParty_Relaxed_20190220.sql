...
(
	...
	taxIdentificationNumberObfuscated VARCHAR(250) NULL, /*For aliens and corporations (called EIN)*/ -- DCR /*LEN 15*/
	taxIdentificationNumberLastFour VARCHAR(250) NULL, /*For aliens and corporations (called EIN)*/ -- DCR /*CHAR(4)*/
	socialSecurityNumberObfuscated VARCHAR(250) NULL,			-- DCR (N_SSN4 from clt7a /*VARCHAR(30)*/
	socialSecurityNumberLastFour VARCHAR(250) NULL,			-- DCR (N_SSN4 from clt7a /*CHAR(4)*/
	hICNObfuscated VARCHAR(250) NULL,							---4 /*VARCHAR(36)*/
	driversLicenseNumberObfuscated VARCHAR(250) NULL,			-- DCR (N_DRV_LIC from clt8a /*VARCHAR(16)*/
	driversLicenseNumberLast3 VARCHAR(250) NULL,			-- DCR (N_DRV_LIC from clt8a /*CHAR(3)*/ 
	driversLicenseClass VARCHAR(250) NULL,			-- DCR (C_DRV_LIC_CLASS from clt8a /*VARCHAR(2)*/
	driversLicenseState VARCHAR(250) NULL,				-- DCR (C_ST_ALPH from clt8a /*CHAR(2)*/
	genderCode VARCHAR(250) NULL,						-- DCR {C_GEND from clt4 /*CHAR(2)*/
	passportID VARCHAR(250) NULL,							-- DCR {N_PSPRT from clt4 /*VARCHAR(9)*/
	professionalMedicalLicense VARCHAR(250) NULL,	-- DCR (N_PROF_MED_LIC FROM CLT10 /*VARCHAR(20)*/
	...
	fullName /*M_FUL_NM*/ VARCHAR(250) NULL, /*VARCHAR(70)*/
	firstName VARCHAR(250) NULL, /*VARCHAR(100)*/
	middleName VARCHAR(250) NULL, /*VARCHAR(100)*/
	lastName VARCHAR(250) NULL, /*VARCHAR(100)*/
	suffix VARCHAR(250) NULL, /*VARCHAR(50)*/
	/*SourceSystemColumn,*/
	/*roleType,*/
	isActive BIT NOT NULL,		
	dateInserted DATETIME2(0) NOT NULL,
	isoClaimId VARCHAR(250) NULL, /*I_ALLCLM*/ /*VARCHAR(11)*/

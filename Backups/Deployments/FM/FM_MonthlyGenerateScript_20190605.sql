...
FROM
	...
	(
		VALUES
			(CAST('2019-08-01' AS DATE),CAST('2019-04-05' AS DATE)),
			(CAST('2019-07-01' AS DATE),CAST('2019-06-05' AS DATE))
...
END
GO
--SELECT * FROM dbo.FireMarshalGenerationLog
--SELECT TOP 10000 * FROM dbo.FireMarshalClaimSendHistory
--WHERE

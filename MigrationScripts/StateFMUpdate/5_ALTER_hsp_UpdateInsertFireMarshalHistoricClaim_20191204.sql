		...
		BEGIN
			...
			UPDATE dbo.FireMarshalClaimSendHistory
				SET
					...
					FireMarshalClaimSendHistory.lossGeoCountyFipsCode = SOURCE.lossGeoCountyFipsCode
			FROM
			...
			WHERE
				...
				AND (
					...
					OR ISNULL(FireMarshalClaimSendHistory.lossGeoCountyFipsCode,'~~~~~') <> ISNULL(SOURCE.lossGeoCountyFipsCode,'~~~~~')
				);

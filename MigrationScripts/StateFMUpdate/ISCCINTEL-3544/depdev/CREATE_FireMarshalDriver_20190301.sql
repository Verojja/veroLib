...
(   
	...
	*/
	adhocIncludesValidLossDescription BIT NOT NULL, /*FLAG_VALID_LOSS_DESC*/
	adhocIncludesValidLossDescriptionLength BIT NOT NULL, /*FLAG_VALID_LOSS_DESC_LENGTH*/
	adhocIncludesValidLossEstimate BIT NOT NULL, /*FLAG_VALID_LOSS_ESTIMATE*/
	adhocIncludesValidLossSettlement BIT NOT NULL, /*FLAG_VALID_LOSS_SETTLEMENT*/
	/*
		lossEstimateAmount DECIMAL(19,2) NOT NULL, /*A_EST_LOSS*/
		settlementAmount DECIMAL(19,2) NOT NULL,/*A_STTLMT*/
	*/
	isActive BIT NOT NULL, 
	adhocFMPerspectiveTypeId TINYINT NULL,
	adhocFMStateStatusCode CHAR(1) NULL,

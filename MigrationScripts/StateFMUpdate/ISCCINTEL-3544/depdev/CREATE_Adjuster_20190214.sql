...
CREATE NONCLUSTERED INDEX NIX_Adjuster_isoClaimId_involvedPartySequenceId_adjusterSequenceId
	...
	INCLUDE (adjusterCompanyCode, adjusterCompanyName, adjusterOfficeCode, adjusterDateSubmitted, adjusterName, adjusterAreaCode, adjusterPhoneNumber, isActive, dateInserted);
GO
IF(@@TRANCOUNT <1 OR @@ERROR <> 0)
BEGIN
	ROLLBACK TRANSACTION;
